        ...
        <form method="POST" action="functions.php">
            ...
            <div class="form-group">
              ...
              <div class="calendario">
                <label for="calendario">Data a Agendar</label><input type="date" name="data_agendamento" id="data_agendamento"></div>
<hr>
    <script>
         let cliente; 
         ...
         function alteraServico(){
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="obs" name ="obs" rows="10" cols="100">Digite aqui algo que o profissional precise saber.</textarea>
            </div>
